...
My dissertation investigates the potential of the "customer-centric TV advertising strategy," an optimal customer-specific TV targeting strategy along the customer lifecycle. In the dissertation, I develop a decision support system that (1) estimates the causal effect of TV advertising from large scale observational data and (2) yields the optimal the addressable TV advertising targeting policy along the customer lifecycle.
